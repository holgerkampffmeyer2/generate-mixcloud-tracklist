# AI Harness Scorecard: generate-mixcloud-tracklist

**Grade: F** (14.9/100) | No meaningful harness. AI output is essentially unaudited.

- **Repository**: `/home/runner/work/generate-mixcloud-tracklist/generate-mixcloud-tracklist`
- **Languages**: none detected
- **Assessed**: 2026-05-02 14:16 UTC
- **Checks**: 5/31 passed
...
| AI-Specific Safeguards | 15% | 23% [##--------] | 2/5 |
...
## AI-Specific Safeguards (23%)

### [PASS] AI Usage Norms (2/4)

_DORA 2025 - clear organizational stance on AI use_

**Evidence**: Agent file found (AGENTS.md) but no explicit review norms detected

**Remediation**: Add a section on AI review expectations: what reviewers should specifically check in AI-generated code, when to require manual implementation.
